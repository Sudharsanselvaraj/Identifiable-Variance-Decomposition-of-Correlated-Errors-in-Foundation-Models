...
% Schematic generated from the documented causal structure (docs/05_Experiments).
...
% Real occupancy heatmap (src/results/phase2/figures/design_heatmap.pdf source data).
...
% Trace from the committed g3_report.md search trace (deterministic battery).
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){figs/fig_similarity.png}
...
% Labeled pending placeholder; replaced by the real overlap panel after the eval pass.

\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){figs/fig_partition.png}
...
% Labeled pending placeholder; replaced by the real share figure (variance_shares.pdf) after the eval pass.
