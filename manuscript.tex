...
\author{
\IEEEauthorblockN{Sudharsan~S\IEEEauthorrefmark{1},
S.~Kanaga Suba Raja\IEEEauthorrefmark{1,2},
Shree Harish~V\IEEEauthorrefmark{2,3},
Chin-Shiuh Shieh\IEEEauthorrefmark{3},
Mong-Fong Horng\IEEEauthorrefmark{3},
Lavanya~R\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Department of Computer Science and Engineering,
SRM Institute of Science and Technology,
Tiruchirappalli 620101, India}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Research Institute of IoT Cybersecurity,
Department of Electrical Engineering,
National Kaohsiung University of Science and Technology,
Kaohsiung 824, Taiwan, ROC}
\IEEEauthorblockA{\IEEEauthorrefmark{3}Research Institute of IoT Cybersecurity,
Department of Electrical Engineering,
National Kaohsiung University of Science and Technology,
Kaohsiung 824, Taiwan, ROC}
}
...
\item \textbf{22-model selected population:} The minimum valid population within the 47-model candidate frame identified by the G3 outcome-independent design procedure. Not fully measured (16 of 22 were evaluated; DeepSeek-V3.1/V3.2 could not be evaluated due to compute constraints).
...
These features jointly induce one linearly dependent direction in the fitted design matrix. Full rank is a necessary but not sufficient condition: even designs that achieve full rank can fail the condition number gate (Section~\ref{sec:design_sensitivity}).
...
\midrule
Current (16-model) & 16 & 5 & 14 & 14/15 & $4.7\times10^{16}$ & $\infty$ & \textbf{FAIL} \\
...
Full column rank ensures that all effects in the model are estimable. Without it, the variance components are aliased and no estimator can separate them. The 16-model population fails this requirement because of missing families and singleton families.
