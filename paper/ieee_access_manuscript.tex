...
\begin{table}[!t]
\caption{\textbf{TABLE~VI: Family-Era Occupancy of the 16 Measured Models.} 8 of 11 occupied quarters contain only one model; 40 of 55 possible family-quarter cells are empty (73\% sparse).}
\label{tab:occupancy}
\centering
\footnotesize
...
\hline
Current (16) & 16 & 5 & 11 & 14/15 & $4.7\!\times\!10^{16}$ & $\infty$ & \textbf{FAIL} \\
\hline
...
The empirical application to 16 real foundation models demonstrates that a realistic model population can fail the identifiability gate: the design is rank-deficient (rank 14 of 15), numerically unstable ($\kappa = 4.7 \times 10^{16}$), and has infinite variance inflation. The failure is structural, caused by a singleton family--era confound (Llama alone in 2023Q1) and additional crossing violations. The intended lineage-era variance decomposition is therefore not identifiable on this population and is not interpreted.
